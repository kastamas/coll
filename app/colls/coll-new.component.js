  ...
  .controller("CollNewCtrl", [
    ...
    function($scope, $http, $location, $routeParams, $timeout, $window) {
      ...
      ctrl.bulk = {
        ...
        keyCatcher: function(keyEvent) {
          // todo: there is a way to grow
        ...
        change: function(file) {
          ...
          file.$upload("./api/htmlParseSpec", file, ctrl.bulk.permit).then(
            ...
            function(data) {
              ...
              ctrl.bulk.errors = angular.isArray(ctrl.bulk.errors)
                ? ctrl.bulk.errors.concat(data.response)
